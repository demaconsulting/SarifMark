...
3. **Framework operation**: xUnit v3 (the test framework, replacing MSTest in practice) is verified implicitly — the
...
- MSTest / xUnit v3 — unit and integration test framework
